import { BlockQuery, EvmBeaconV1Interface, EvmBeaconResponse, StateCommitteesQuery, StateQuery, StateSyncCommitteesQuery, ValidatorBalancesQuery, ValidatorQuery, ValidatorsQuery } from '../../../dto';
